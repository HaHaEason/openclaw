import ipaddr, { type IPv4 as Ipv4Address, type IPv6 as Ipv6Address } from "ipaddr.js";

export type ParsedIpAddress = Ipv4Address | Ipv6Address;
type Ipv4Range = ReturnType<Ipv4Address["range"]>;
type Ipv6Range = ReturnType<Ipv6Address["range"]>;
